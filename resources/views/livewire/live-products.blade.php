...
<div x-data="{ cartOpen: false , isOpen: false }" class="bg-white">
    <header>
        <div class="container mx-auto px-6 py-3">
            ...
            <span class="absolute inset-y-0 left-0 pl-3 flex items-center" >
                ...
                <input  wire:model.debounce.500ms="search"  value="{{old('search')}}"  class="w-full border rounded-md pl-10 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search">
    ...
    <div :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in' " class="fixed z-10 right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300">
        <div class="flex items-center justify-between">
            <h3 class="text-2xl font-medium text-gray-700">Your cart &#x20b5; {{\Cart::total()}}</h3>
            ...
            <div class="flex">
                ...
                <div class="mx-3">
                    ...
                    <div class="flex items-center mt-2">
                        ...
                        <button type="button" class="flex text-gray-500 focus:outline-none focus:text-gray-600 space-x-2" wire:click = "remove_item('{{$item->rowId}}')">
                            <svg class="h-5 w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> <div class="">Remove</div>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <main class="my-8">
        ...
        @endif
            ...
            <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6  ">
               ...
               <div id="{{$vegs->id}}"  wire:loading.class="animate-pulse">
                <p  wire:model="itemid" hidden >{{$vegs->id}}</p>
                <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden" id="{{$vegs->id }}">
                    <div  class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url({{ asset('images/peek.jpg') }}) ">
                        <p id="profileImage" class="text-gray-600 shadow-lg  space-x-5 mb-5">PeekVeg</p>
                        <button  wire:click="add_item({{$vegs->id}})" class="p-2 rounded-full bg-blue-600 text-white mx-5 -mb-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
               ...
               @empty
                ...
                <div  wire:loading.class="animate-pulse" >
                    ...
                    <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden pb-12"  >
                        <div  wire:loading.class="animate-pulse" class="flex items-end justify-end  h-56 w-full bg-cover" style="background-image: url({{ asset('images/peek.jpg') }}) ">
