                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-black-600 dark:text-black-400 text-sm">
                                   Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel exercitationem, nam distinctio quae quibusdam voluptatem, facilis officiis ipsa voluptatibus asperiores quidem totam quaerat. Temporibus dolore accusantium nobis esse. Praesentium, officiis.
                                </div>
                            </div>
                        </div>
                    </div>
